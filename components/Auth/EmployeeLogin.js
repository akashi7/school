...
const EmployeeLogin = ({ setActiveLogin, lang }) => {
		...
		>
			...
			>
				...
				<Col className="font-[500] text-dark text-[24px] truncate" flex={1}>
					{lang?.auth?.as_employee?.title}
				</Col>
			</Row>

			<div className="w-[100%]">
				<CustomInput
					label={lang?.auth?.as_employee?.country_name}
			...
			<div className="w-[100%]">
				<CustomInput
					label={lang?.auth?.as_employee?.identifier}
